...
export const enTranslations: Translations = {
  ...
  'services.database.subtitle': 'Custom database solutions',
  ...
  'services.support.response.desc': 'Guaranteed response times',
  'services.support.ai': 'AI Support',
  'services.support.ai.desc': 'AI-powered problem solving',
  'services.admin.title': 'IT Administration',
  'services.admin.subtitle': 'Professional IT administration',
  'services.admin.workstation': 'Workstation Management',
  'services.admin.workstation.desc': 'Efficient workstation management',
  'services.admin.server': 'Server Management',
  'services.admin.server.desc': 'Reliable server administration',
  ...
  'services.admin.aiIntegration.desc': 'Integration of AI solutions',
